...
#here put the variables you want!!!
dat_01f=dat_01%>%select(f1:f5,e3,e4,c4,c7,c11,c12,problem_drinking,a5,a6,a8d,a2,g6,g7,g8,g3,g15,g16)%>%na.omit()
...
gg_miss_upset(dat_01%>%select(f1:f5,e3,e4,c7,c4,c7,c11,c12,problem_drinking,a5,a6,a8d,a2,g6,g7,g8,g3,g15,g16,c4))
...
dat_01_97=dat_01%>%filter(study_id%in%ids01_97,f5!=99,f5!=10)%>%select(study_id,a5,a6,a8d,c7,c11,c12,problem_drinking,f5,e4,a2,g6,g3,g15,g14,g16,c4)
nrow(dat_01_97)/nrow(dat2001)

# plz add drinking here (BK: I did, just added c5, for 1997)
ids97_01=dat_97%>% dplyr::select(study_id,e3,f4,a2,c5,c11,c12,problem_drinking,g8,g3,g15,g14,g16,c8)%>%na.omit()%>%pull(study_id)

# select complete cases for 2001
dat_97_01=dat_97%>%filter(study_id%in%ids97_01,f4!=10)%>%mutate(c8=c8-1)%>%select(study_id,e3,f4,a2,c5,c11,c12,problem_drinking,g8,g3,g15,g14,g16,c8)
