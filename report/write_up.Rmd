...
In terms of model fit evaluation, our model achieves good fit with $[0.029, 0.031]$ Root Mean Square Error of Approximation (RMSEA), which is less than the $0.05$ "good fit" cutoff as suggested by [@maccallum1996power].
